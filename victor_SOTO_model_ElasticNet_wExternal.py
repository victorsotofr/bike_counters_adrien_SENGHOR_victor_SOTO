...
# Save to CSV:
output_df.to_csv('victor_SOTO_submission_ElasticNet_wExternal_v0.csv', index=False)
print("Predictions saved to 'victor_SOTO_submission_ElasticNet_wExternal_v0.csv'.")