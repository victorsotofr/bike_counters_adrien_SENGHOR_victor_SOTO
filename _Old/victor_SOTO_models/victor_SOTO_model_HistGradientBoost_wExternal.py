...
pipeline = make_pipeline(
    ...
    HistGradientBoostingRegressor(max_depth=30) # GradientBoosting regression model
)
...
# Save to CSV:
output_df.to_csv('victor_SOTO_submission_HistGradientBoosting_wExternal_v2.csv', index=False)
print("Predictions saved to 'victor_SOTO_submission_HistGradientBoosting_wExternal_v2.csv'.")